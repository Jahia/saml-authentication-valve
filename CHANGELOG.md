...
* Drop the unused velocity-tools dependency and record the pac4j CSRF analysis (#201)
...
* Updated bouncycastle from 1.78 to 1.83 (#174)
...
* Fixed the SAML login button so a title that contains special characters now renders as written. The form it submits now posts to a fixed address, instead of one built from the name of the page it sits on.
