...
describe('Login via SAML on Private Site', () => {
    ...
    it('Trying to connect on a site without SAML config must raise an HTTP 400 error', () => {
    ...
    it('Trying to connect without giving a sitekey must raise an HTT 400 error', () => {
    ...
    it('Trying a callback on a site without SAML config must raise an HTTP 400 error', () => {
    ...
    it('Trying to get metadata on a site without SAML config must raise an HTTP 400 error', () => {
